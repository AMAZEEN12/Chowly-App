...
export default function StaffDashboardPage() {
  ...
  return <main className="container page"><div className="page-title"><span className="eyebrow">{user.restaurant?.name || 'Restaurant'} • {user.role}</span><h1>Service dashboard</h1></div><div className=
